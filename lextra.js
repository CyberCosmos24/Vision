...
//This will gather all the commands and event files and group them, So the handler is done at this point
...
//This is where the slash commands are managed
...
//This will report to the log file/console when someone deletes a message, More info here: https://discordjs.guide/popular-topics/audit-logs.html#who-kicked-a-user
...
//This will report to the log file/console when someone gets kicked or left a server, More info here: https://discordjs.guide/popular-topics/audit-logs.html#who-kicked-a-user
...
//This will report to the log file/console when someone gets banned from a server, More info here: https://discordjs.guide/popular-topics/audit-logs.html#who-kicked-a-user
...
//This is another thing I came up with a few years ago and still use it since it comes in handy for logging not just commands/errors/function 
//it can log a message sent to a channel in a server with the message logged/displayed
client.on('messageCreate', message => {
    crimson.info(`\n[${message.channel.guild}] - [${message.author.tag}]>: ` + message.content);
});


//This just launches the bot(I would highly recommend not messing with this)
client.login(token);
